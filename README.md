...
As the title says, this program simply computes for the product matrix of two input square matrices written in CUDA-C; an extension of ANSI-C with NVidia CUDA GPU computing capabilities. 
